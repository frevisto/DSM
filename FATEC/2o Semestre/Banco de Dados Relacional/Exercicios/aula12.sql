...
VALUES (
    ...
    (
        'Ana Luiza Souza',
        '1992-02-25',
        'Avenida das Palmeiras, 101, Belo Horizonte, MG',
        'F',
        5300.00,
        3
    ),
    (
        'Carlos Pereira',
        '1986-09-18',
        'Rua dos Coqueiros, 222, Fortaleza, CE',
        'M',
        5100.00,
        3
    ),
    (
        'Mariana Santos',
        '1991-12-08',
        'Avenida das Árvores, 333, Recife, PE',
        'F',
        4900.00,
        3
    ),
    (
        'Paulo Rodrigues',
        '1989-04-30',
        'Rua das Pedras, 444, Brasília, DF',
        'M',
        5500.00,
        7
    ),
    (
        'Luísa Ferreira',
        '1993-08-05',
        'Avenida das Flores, 555, Porto Alegre, RS',
        'F',
        5100.00,
        8
    ),
    ...
    (
        'Ricardo Almeida',
        '1987-06-19',
        'Rua das Estrelas, 888, São Luís, MA',
        'M',
        5300.00,
        10
    ),
    ...
    (
        'Gustavo Costa',
        '1988-04-03',
        'Rua das Montanhas, 1111, Florianópolis, SC',
        'M',
        5600.00,
        10
    ),
    (
        'Juliana Vieira',
        '1993-07-28',
        'Avenida da Praça, 1234, Cuiabá, MT',
        'F',
        5200.00,
        10
    ),
    ...
    (
        'Luciana Ferreira',
        '1991-05-11',
        'Avenida da Cachoeira, 9876, Curitiba, PR',
        'F',
        5400.00,
        15
    ),
    (
        'André Oliveira',
        '1986-02-14',
        'Rua das Cascatas, 5432, Maceió, AL',
        'M',
        5300.00,
        17
    ),
    (
        'Patrícia Gomes',
        '1990-11-29',
        'Avenida das Dunas, 8765, Vitória, ES',
        'F',
        5100.00,
        18
    ),
    ...
    (
        'Laura Ribeiro',
        '1992-06-08',
        'Avenida das Ondas, 8642, João Pessoa, PB',
        'F',
        5200.00,
        20
    ),
    (
        'Roberto Alves',
        '1988-12-01',
        'Rua dos Lagos, 2468, Teresina, PI',
        'M',
        5400.00,
        20
    ),
    (
        'Aline Barbosa',
        '1993-04-17',
        'Avenida dos Rios, 9753, Boa Vista, RR',
        'F',
        5100.00,
        20
    ),
    ...
    (
        'Elaine Silva',
        '1991-09-26',
        'Avenida das Praias, 4321, Aracaju, SE',
        'F',
        5300.00,
        20
    ),
    (
        'Cristiano Santos',
        '1988-08-09',
        'Rua das Montanhas, 8765, Porto Velho, RO',
        'M',
        5000.00,
        20
    ),
    (
        'Adriana Lima',
        '1993-01-05',
        'Avenida do Céu, 7890, Boa Vista, RR',
        'F',
        5600.00,
        20
    ),
    (
        'Renato Gomes',
        '1986-09-25',
        'Rua das Estrelas, 6543, Rio Branco, AC',
        'M',
        5200.00,
        20
    ),
    (
        'Isabella Carvalho',
        '1990-05-19',
        'Avenida da Lua, 9876, Vitória, ES',
        'F',
        5500.00,
        28
    ),
    ...
    (
        'Larissa Martins',
        '1992-08-28',
        'Avenida das Ondas, 2345, João Pessoa, PB',
        'F',
        5400.00,
        30
    ),
    (
        'Rafael Ferreira',
        '1986-10-23',
        'Rua das Praias, 6543, Aracaju, SE',
        'M',
        5200.00,
        31
    ),
    (
        'Carolina Santos',
        '1990-02-10',
        'Avenida dos Rios, 9876, Porto Velho, RO',
        'F',
        5000.00,
        32
    ),
    (
        'Bruno Oliveira',
        '1989-07-07',
        'Rua dos Campos, 5432, Teresina, PI',
        'M',
        5300.00,
        33
    ),
    (
        'Fernanda Barbosa',
        '1992-03-14',
        'Avenida das Dunas, 1357, Teresina, PI',
        'F',
        5600.00,
        34
    ),
    ...
    (
        'Silvia Lima',
        '1991-02-03',
        'Avenida da Praça, 8765, Campo Grande, MS',
        'F',
        5200.00,
        36
    ),
    (
        'Daniel Almeida',
        '1988-06-11',
        'Rua das Cascatas, 1234, Palmas, TO',
        'M',
        5400.00,
        36
    ),
    (
        'Mônica Vieira',
        '1993-11-30',
        'Avenida da Serra, 2468, Natal, RN',
        'F',
        5300.00,
        36
    ),
    (
        'Gustavo Gomes',
        '1986-09-25',
        'Rua das Montanhas, 5432, Belo Horizonte, MG',
        'M',
        5700.00,
        36
    ),
    (
        'Lúcia Castro',
        '1990-05-19',
        'Avenida das Árvores, 7890, Curitiba, PR',
        'F',
        5600.00,
        36
    );
