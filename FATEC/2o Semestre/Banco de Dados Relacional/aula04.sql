...
INSERT INTO tbl_cliente VALUES (1,'João Silva','São Paulo','Rua A, 123'),(2,'Maria Santos','Rio de Janeiro','Av. B, 456'),(3,'Pedro Almeida','Belo Horizonte','Rua C, 789'),(4,'Ana Oliveira','Salvador','Av. D, 1011'),(5,'Carlos Lima','Brasília','Rua E, 1213');

-- Inserir dados na tabela tbl_titulo

INSERT INTO tbl_titulo(codigo_titulo,titulo,descricao,categoria) VALUES (1,'Aventuras Urbanas','Uma História Emocionante','DRAMA'),(2,'Mistérios Antigos','Enigmas por Resolver','COMEDIA'),(3,'Amor nas Estrelas','Um romance intergalático','DRAMA'),(4,'Código Enigmático','Segredos Ocultos','COMEDIA'),(5,'Histórias Perdidas','Contos esquecidos','DRAMA');

-- Inserir dados na tabela tbl_livros

INSERT INTO tbl_livros(codigo_livro,codigo_titulo,status) VALUES (1,1,DISPONIVEL),(2,1,ALUGADO),(3,2,DISPONIVEL),(4,3,ALUGADO),(5,4,DISPONIVEL);
...
SELECT nome FROM tbl_cliente WHERE cidade = 'São Paulo';
...
--Copie todos os códigos da tbl_cliente para essa nova tabela usando o SQL Insert.
