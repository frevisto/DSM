  ...
  public async list(_: Request, res: Response): Promise<any> {
    try {
      const objects = await Professor_has_Disciplina.find()
        .populate("professor")
        /* Por exemplo, se o documento em Professor_has_Disciplina tiver o campo professor
         com o valor do ID do professor, com o .populate("professor"), esse campo será substituído
         pelo objeto completo do professor.*/
        .populate("disciplina")
        // idém acima.
